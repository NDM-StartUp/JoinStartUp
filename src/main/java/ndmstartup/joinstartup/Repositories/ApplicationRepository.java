...
public interface ApplicationRepository extends JpaRepository<ApplicationCv, Long> {
	...
	List<ApplicationCv> findByStartupIdAndDatePeriod(@Param("startDate") Date startDate, @Param("endDate") Date endDate, @Param("startUpId") Long startUpId);
	...
	List<ApplicationCv> findByStartupIdAndStatusAndDatePeriod(@Param("applicationStatus") String applicationStatus, @Param("startDate") Date startDate, @Param("endDate") Date endDate, @Param("startUpId") Long startUpId);
	...
	List<ApplicationCv> findByEmployeeIdAndStatusAndDatePeriod(@Param("applicationStatus") String applicationStatus, @Param("startDate") Date startDate, @Param("endDate") Date endDate, @Param("employeeId") Long employeeId);
	...
	List<ApplicationCv> findByEmployeeIdAndDatePeriod(@Param("startDate") Date startDate, @Param("endDate") Date endDate, @Param("employeeId") Long employeeId);
}
